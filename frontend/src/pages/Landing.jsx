  ...
  const features = [
    {
      ...
      description: 'Advanced machine learning algorithms analyze your data to uncover hidden patterns and actionable insights',
    ...
    },
    {
      ...
      description: 'Identify trends, clusters, and anomalies in your data with intelligent pattern recognition',
  ...
  const testimonials = [
    {
      ...
      avatar: '👩‍💻',
      quote: 'InsightWhiz transformed how we analyze customer data. The AI insights are incredibly accurate!'
    },
    {
      name: 'Marcus Johnson',
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
              Join <span className="font-bold text-yellow-300">50,000+</span> professionals who trust InsightWhiz 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 mb-4 md:mb-0">
              © 2024 InsightWhiz. All rights reserved. Made with ❤️ for data lovers.
            </p>
            <div className="flex items-center space-x-6 text-gray-400">
